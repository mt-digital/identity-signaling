...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{Figures/dislikingHomophilySeries.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=0.8\textwidth]{Figures/covertDensityVsDislikingHomophily.pdf}
  \caption{Density of covert signalers at $t=100$, final timestep recorded
    in this preliminary experiment.}
