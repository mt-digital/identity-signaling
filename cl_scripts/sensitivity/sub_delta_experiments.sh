...
# 10 trials.
for ii in {1..5}; do
    # Set delta to be three different values and run basic
    # experiment.
...
# subexp disliking 0.05:0.86:0.2 0.0:0.51:0.05 100 10 yo.csv -d -R1.0  \
#     --two_dislike_penalty=0.9 \
#     -qXXXX-ib.q -j$fname -n24 -t"04:00:00"
